...
export const InstructorLayout = () => {
  ...
  const navItems = [
    { label: 'Overview', path: '/instructor/dashboard', icon: LayoutDashboard },
    ...
    { label: 'Live Masterclasses', path: '/instructor/live-classes', icon: Video, badge: 'LIVE' },
    { label: 'Faculty Settings', path: '/instructor/settings', icon: Settings },
  ];
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:block text-left">
              <p className="text-xs font-bold text-gray-900 leading-tight">{user?.name || 'Dr. Elena Rostova'}</p>
              <p className="text-[10px] text-amber-700 font-mono font-semibold">Senior Faculty</p>
            </div>
          </div>
        </div>
      </header>
              ...
              >
                ...
                {isSidebarOpen && (
                  <div className="flex-1 flex items-center justify-between truncate">
                    ...
                    {item.badge && (
                      <span className={`px-1.5 py-0.5 text-[10px] font-bold rounded shrink-0 ml-1 ${
                        item.badge === 'LIVE'
